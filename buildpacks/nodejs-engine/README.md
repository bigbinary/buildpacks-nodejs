...
with `npm install`, additionally use the [`neetodeploy/nodejs-npm`](../npm/README.md)
buildpack. Alternatively, use the [`neetodeploy/nodejs`](../../meta-buildpacks/nodejs/README.md)
meta-buildpack, which includes both buildpacks.

To install `yarn` and/or install `node_modules` with `yarn`, additionally use
the [`neetodeploy/nodejs-yarn`](../npm/README.md) buildpack. Alternatively, use the [`neetodeploy/nodejs`](../../meta-buildpacks/nodejs/README.md)
meta-buildpack, which includes both buildpacks.
...
```
pack build example-app-image --buildpack neetodeploy/nodejs-engine --path /some/example-app
```
